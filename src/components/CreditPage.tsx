    ...
    <div className="space-y-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 text-lg">Gérez votre solde de crédits et accédez aux fonctionnalités premium</p>
        </div>
      </motion.div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{currentUser.creditBalance || 0} crédits</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-xs text-gray-500 mb-1">Disponible</p>
            <p className="text-sm font-medium text-green-600">{currentUser.creditBalance || 0 > 0 ? 'Actif' : 'Épuisé'}</p>
          </div>
        </div>
      </motion.div>
              ...
              >
                {pkg.isFeatured && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <span className="bg-[#1e51ab] text-white text-xs px-3 py-1 rounded-full">Populaire</span>
                  </div>
                )}
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900 mb-4">{creditService.formatPrice(pkg.priceCents)}€</div>
      ...
      >
        <div className="flex items-start">
          ...
          <div>
            <h3 className="text-lg font-semibold text-blue-900 mb-3">Comment fonctionnent les crédits ?</h3>
            <div className="space-y-4 text-sm text-blue-800">
              <div>
                <h4 className="font-medium mb-3 text-blue-900">Tarification des fonctionnalités :</h4>
                <div className="space-y-2">
                  <div className="flex items-start justify-between">
                    <span>• Questions au ChatBot</span>
                    <span className="font-semibold">1 crédit par question</span>
                  </div>
                  <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <span className="font-semibold">1 crédit</span>
                  </div>
                </div>
              </div>

              <div>
                <h4 className="font-medium mb-2 text-blue-900">Informations importantes :</h4>
                <ul className="space-y-1">
                  <li>• Crédits valables 1 an après achat</li>
                  <li>• Paiement sécurisé par carte bancaire</li>
                  <li>• Aucun engagement, utilisez vos crédits à votre rythme</li>
                </ul>
              </div>
            </div>
          </div>
