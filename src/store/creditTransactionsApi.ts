...
export const creditTransactionsApi = createApi({
  ...
  endpoints: (build) => ({
    getCreditTransactions: build.query<CreditTransactionsResponse, CreditTransactionsFilters | void>({
      query: (filters) => {
...
export const { useGetCreditTransactionsQuery, useLazyGetCreditTransactionsQuery } = creditTransactionsApi;
